...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Socket = __webpack_require__(96);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(146);
	var warning = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socket = __webpack_require__(93);

	var _socket2 = _interopRequireDefault(_socket);

	var _newUser = __webpack_require__(216);
	...
	var Chat = function (_React$Component) {
	    ...
	    function Chat(props) {
	        ...
	        _this.replaceMessage = function (message) {
	        ...
	        _this.handleJoined = function (data) {
	            _this.setState(function (curState) {
	        ...
	        _this.handleConnected = function (data) {
	        ...
	        _this.mapMessages = function (message) {
	            if (message.type === 'plugin') {
	                var P = Plugins[message.pluginName];
	                return _react2.default.createElement(
	                    'li',
	                    null,
	                    _react2.default.createElement(P, { key: message.data.id, data: message.data })
	                );
	            }
	            return _react2.default.createElement(
	                'li',
	        ...
	        _this.state.socket.on('connected', _this.handleConnected);
	        _this.state.socket.on('message', _this.handleMessage);
	        _this.state.socket.on('joined', _this.handleJoined);
	        _this.state.socket.on('left', _this.handleLeft);
	        _this.state.socket.on('replaceMessage', _this.replaceMessage);
	        return _this;
	    }
	    ...
	    _createClass(Chat, [{
	        ...
	        value: function render() {
	            if (!this.state.user) {
	                return _react2.default.createElement(_newUser2.default, null);
	            }
	            return _react2.default.createElement(
	                'div',
	                { className: 'chat' },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('input', { ref: 'input', type: 'text', placeholder: 'type message here...', value: this.state.currentMessage, onChange: this.handleChange }),
	                    _react2.default.createElement(
	                        'button',
	                        { type: 'submit' },
	                        '->'
	...
	var render = exports.render = function render(node) {
	    _reactDom2.default.render(_react2.default.createElement(Chat, null), node);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewUser = function (_React$Component) {
	    ...
	    function NewUser(props, context) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NewUser).call(this, props, context));

	        _this.handleSubmit = function (e) {
	            e.preventDefault();
	            console.log("Connecting as " + _this.state.name);
	            _this.context.socket.emit('connected', _this.state.name);
	        };
	    ...
	    _createClass(NewUser, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "form",
	                { onSubmit: this.handleSubmit },
	                _react2.default.createElement("input", { ref: "input", type: "text", placeholder: "Name", value: this.state.name, onChange: this.handleChange }),
	                _react2.default.createElement(
	                    "button",
	                    { type: "submit" },
	                    "Sign In"
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.gify = exports.pointingpoker = undefined;

	var _pointingpoker2 = __webpack_require__(219);

	var _pointingpoker3 = _interopRequireDefault(_pointingpoker2);

	var _gify2 = __webpack_require__(218);

	var _gify3 = _interopRequireDefault(_gify2);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.pointingpoker = _pointingpoker3.default;
	exports.gify = _gify3.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (props) {
	    return _react2.default.createElement(
	        "video",
	        { width: props.data.images.original.width, height: props.data.images.original.height, poster: props.data.images.original.webp, autoplay: true },
	        _react2.default.createElement("source", { src: props.data.images.original.mp4, type: "video/mp4" })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PointingPoker = function (_React$Component) {
	    _inherits(PointingPoker, _React$Component);

	    function PointingPoker(props, context) {
	        _classCallCheck(this, PointingPoker);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PointingPoker).call(this, props, context));

	        _this.handleUnVote = function (val) {
	        ...
	        _this.optionsToArray = function (options) {
	            var out = [];
	        ...
	        _this.vote = function (e) {
	            var val = e.target.dataset.val;
	            if (_this.state.current) {
	                _this.state.socket.emit('unvote', _this.state.current);
	                _this.handleUnVote(_this.state.current);
	            }
	            _this.setState({ current: val });
	            _this.handleVote(val);
	            _this.state.socket.emit('vote', val);
	        };

	        _this.mapOptions = function (option) {
	            return _react2.default.createElement(
	                'button',
	                { onClick: _this.vote, 'data-val': option.val },
	                option.label,
	                ' | ',
	                option.count
	            );
	        ...
	        _this.close = function () {
	            _this.state.socket.emit('close');
	        };

	        _this.state = {
	            options: _this.optionsToArray(props.data.options),
	            socket: (0, _socket2.default)('http://localhost:8000/plugin/pointingpoker/' + props.data.id)
	        };

	        _this.state.socket.on('unvote', _this.handleUnVote);
	        _this.state.socket.on('vote', _this.handleVote);
	        return _this;
	    }

	    _createClass(PointingPoker, [{
